    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/api/auth/sign-in/email")
                        ...
                        .permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/auth/send-verification-email")
                        .permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/auth/request-password-reset")
                        .permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/auth/reset-password")
                        .permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/auth/sign-in/social")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/auth/oauth2/callback/**")
                        .permitAll()
