...
import { CreateDamageReportHandler } from './application/commands/create-damage-report.handler';
import { UpdateDamageReportStatusHandler } from './application/commands/update-damage-report-status.handler';
import { DeleteDamageReportHandler } from './application/commands/delete-damage-report.handler';
import { GetAllDamageReportsHandler } from './application/queries/get-all-damage-reports.handler';
import { GetDamageReportByIdHandler } from './application/queries/get-damage-report-by-id.handler';
