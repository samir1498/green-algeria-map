...
export class AddOrganizerContactToZone1779722358103 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "zones" ADD "organizerContact" character varying`);
        await queryRunner.query(`ALTER TABLE "zones" DROP COLUMN "photos"`);
        await queryRunner.query(`ALTER TABLE "zones" ADD "photos" text`);
        await queryRunner.query(`CREATE INDEX "IDX_7940b0d64329511647f379873f" ON "damage_reports" ("zoneId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_7940b0d64329511647f379873f"`);
        await queryRunner.query(`ALTER TABLE "zones" DROP COLUMN "photos"`);
        await queryRunner.query(`ALTER TABLE "zones" ADD "photos" text array`);
        await queryRunner.query(`ALTER TABLE "zones" DROP COLUMN "organizerContact"`);
        ...
        await queryRunner.query(`ALTER TABLE "session" ADD CONSTRAINT "FK_session_user" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
