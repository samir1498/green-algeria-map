...
import { GetAllZonesHandler } from '../../../modules/zones/application/queries/get-all-zones.handler';
import { GetAllZonesQuery } from '../../../modules/zones/application/queries/get-all-zones.query';
