...
const mockZones: Zone[] = [
  { id: '1', name: 'Zone A', type: 'planting', status: 'completed', lat: 36.5, lng: 3.0, description: '' },
  { id: '2', name: 'Zone B', type: 'trash', status: 'planned', lat: 36.6, lng: 3.1, description: '' },
]
...
describe('zones API', () => {
  ...
  it('create calls POST /zones with input', async () => {
    const input: Omit<Zone, 'id'> = { name: 'New Zone', type: 'planting', status: 'planned', lat: 36, lng: 3, description: '' }
