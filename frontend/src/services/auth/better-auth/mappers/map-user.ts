...
export function mapUser(raw: Record<string, unknown>): AuthUser {
  ...
  const createdAt = raw.createdAt instanceof Date ? raw.createdAt : new Date(raw.createdAt as string)
  const updatedAt = raw.updatedAt instanceof Date ? raw.updatedAt : new Date(raw.updatedAt as string)
