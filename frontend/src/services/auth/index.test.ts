...
import * as sessionModule from './better-auth/session-service.impl'
import * as authModule from './better-auth/auth-service.impl'
...
vi.mock('./better-auth/session-service.impl', () => ({
  betterAuthSessionService: {
    useSession: vi.fn(),
  },
}))

vi.mock('./better-auth/auth-service.impl', () => ({
  betterAuthService: {
    signIn: vi.fn(),
    signUp: vi.fn(),
    signOut: vi.fn(),
